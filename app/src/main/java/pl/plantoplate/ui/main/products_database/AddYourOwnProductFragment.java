...
public class AddYourOwnProductFragment extends Fragment {
    ...
    public void initViews(FragmentAddYourOwnProductBinding binding) {
        chooseProductUnitRadioGroup = binding.toggleGroup;
        productCategoryTextView = binding.kategoriaNapisac;
        addProductButton = binding.buttonZatwierdz;
        productNameEditText = binding.enterTheName;
        changeProductCategoryButton = binding.zmienKategorie;
