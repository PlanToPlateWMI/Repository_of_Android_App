...
public class ProductsSynchronizationPopUp extends DialogFragment {
    ...
    public ProductsSynchronizationPopUp() {
    }

    public ProductsSynchronizationPopUp(MealPlan mealPlan) {
