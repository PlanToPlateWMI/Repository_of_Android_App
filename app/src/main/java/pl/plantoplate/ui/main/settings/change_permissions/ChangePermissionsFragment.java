...
public class ChangePermissionsFragment extends Fragment {
    ...
    public void showChangePermissionsPopUp(UserInfo userInfo){
        ...
        TextView buttonNo = dialog.findViewById(R.id.button_no);
        TextView buttonYes = dialog.findViewById(R.id.button_yes);

        String permFrom = userInfo.getRole().equals("USER") ? "Użytkownik": "Administrator";
        String permTo = permFrom.equals("Użytkownik") ? "Administrator": "Użytkownik";
        String msg = "Czy zmienić uprawnienia użytkownika " + userInfo.getUsername() + " z " + permTo +
                " na " + permFrom + " ?";
        info.setText(msg);
    ...
    public void showSuccessPopUp(){
        ...
        TextView buttonOk = dialog.findViewById(R.id.button_yes);
