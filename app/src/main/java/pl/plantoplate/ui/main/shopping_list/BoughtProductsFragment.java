...
import pl.plantoplate.ui.main.shopping_list.view_models.BoughtProductsListViewModel;
...
public class BoughtProductsFragment extends Fragment {
    ...
    private void setUpRecyclerView() {
        ...
        List<Product> boughtProducts = boughtProductsListViewModel.getBoughtProducts().getValue();
