...
public class SelectedRecipesFragment extends Fragment {
    ...
    public SelectedRecipesFragment() {
    ...
    private void setupViewPager(ViewPager2 viewPager) {
        ...
        SelectedRecipesFragment.ViewPagerAdapter adapter = new SelectedRecipesFragment.ViewPagerAdapter(this);
        adapter.addFragment(new RecipeCategoriesSelectedFragment());
        adapter.addFragment(new ConcreteCategorySelectedFragment("Dania główne"));
        adapter.addFragment(new ConcreteCategorySelectedFragment("Zupy"));
        adapter.addFragment(new ConcreteCategorySelectedFragment("Desery"));
        adapter.addFragment(new ConcreteCategorySelectedFragment("Przekąski"));
        adapter.addFragment(new ConcreteCategorySelectedFragment("Napoje"));
